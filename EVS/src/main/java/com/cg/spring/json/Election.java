...
public class Election
{
	...
	public Election(String election_name, String state, String constituency, LocalDate date) {
		super();
	...
	public Election(Long electionId, String electionName, String state, String constituency, LocalDate date) {
		super();
	...
	public Election(String election_name, String state, String constituency, LocalDate date, Set<Party> party) {
		super();
		this.electionName = election_name;
		this.state = state;
		this.constituency = constituency;
	...
	public Election(Long electionId, String electionName, String state, String constituency, LocalDate date, Set<Party> party) {
		super();
		this.electionId = electionId;
		this.electionName = electionName;
		this.state = state;
